...
nf-tips-dataset-88 = When you enter cryosleep, your body remains stored for up to 72 hours! (the entire shift!) As a ghost, you can use the 'un-cryo' button to wake up and return to it!
...
nf-tips-dataset-111 = Remember, Nash Station is the entry point for all players. It's frowned upon to engage in antagonist behavior or damage property to the station!
...
nf-tips-dataset-120 = There are multiple ways to earn money. Why not get a job on Nash Station, join NFSD, go salvaging, do science, or do something totally illegal? Other players can teach you each one of them!
nf-tips-dataset-121 = As a freelancer, you can get bounties to earn den bullion! Think of which ship would be most likely to have the items you need.
nf-tips-dataset-122 = As a freelancer, remember your code! Keep the den safe, look after Clarrrpy, and cause plenty of trouble.
